...
export default function RegisterPage() {
    ...
    return (
        <section className="glass-card auth-card">
            ...
            <p className="text-slate-600 mb-8 font-medium">ابدأ رحلتك معنا اليوم</p>
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-5" noValidate>
                <div className="space-y-1.5">
                    <label htmlFor="username" className="text-sm font-bold text-slate-700 mr-2">اسم المستخدم</label>
                    <input
                        id="username"
                        name="username"
                        type="text"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="businessName" className="text-sm font-bold text-slate-700 mr-2">اسم المتجر / الشركة</label>
                    <input
                        id="businessName"
                        name="businessName"
                        type="text"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="email" className="text-sm font-bold text-slate-700 mr-2">البريد الإلكتروني</label>
                    <input
                        id="email"
                        name="email"
                        type="email"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="mobile" className="text-sm font-bold text-slate-700 mr-2">رقم الجوال</label>
                    <input
                        id="mobile"
                        name="mobile"
                        type="tel"
                ...
                <div className="space-y-1.5">
                    <label htmlFor="password" className="text-sm font-bold text-slate-700 mr-2">كلمة المرور</label>
                    <input
                        id="password"
                        name="password"
                        type="password"
            ...
            <p className="mt-6 text-xs text-slate-500 text-center font-medium leading-relaxed">
