...
const icon = (path, viewBox = '0 0 24 24') => ({ size = 20, color = 'currentColor', strokeWidth = 1.8, ...rest } = {}) => (
    <svg
...
export const IconWhatsapp = ({ size = 20, ...rest }) => (
...
export const IconScale = icon(<><path d="M12 3v18M3 9l9-6 9 6M3 15l9 6 9-6" /><line x1="3" y1="9" x2="3" y2="15" /><line x1="21" y1="9" x2="21" y2="15" /></>);
